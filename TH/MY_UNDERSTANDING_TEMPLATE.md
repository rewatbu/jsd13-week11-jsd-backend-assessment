...
ส่วน client/frontend เอาโค้ดที่เอไอเจนมาใช้เพราะเวลาไม่พอและอยากเห็นการทำงานด้วยกันระหว่าง backend กับ frontend
ซึ่งเวลาที่เหลือวันนี้อาจไม่สามารถทำอะไรต่อได้มากไปกว่านี้
...
*คำตอบของคุณ:*
บั๊ก cannot PUT / PATCH ซึ่งเกิดจากการใส่ PUT แทน PATCH method
ก่อนที่จะแก้ได้ก็สับสนว่า id อาจจะไม่ตรงเพราะเป็น string กับ number แล้วทำให้ได้ product not found 
